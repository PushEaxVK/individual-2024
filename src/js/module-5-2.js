...
const bookTasks = () => {
  ...
  (() => {
    console.log(
      ...
      books.find(({ genre, price }) => genre === 'Romance' && price < 8),
    );
  })();
  ...
  (() => {
    console.log(
      ...
      books.find(book => book.title.includes('and')),
    );
  })();
  ...
  (() => {
    console.log(
      ...
      books.find(({ author }) => author === 'J.R.R. Tolkien'),
    );
  })();
  ...
  (() => {
    console.log(
      ...
      books.find(({ genre, rating }) => genre === 'Historical' && rating > 4.7),
    );
  })();
  ...
  (() => {
    console.log(
      ...
      books.some(({ author }) => author === 'Fyodor Dostoevsky'),
    );
  })();
  ...
  (() => {
    console.log(
      ...
      books.some(({ genre, price }) => {
        return genre === 'Romance' && price < 8;
      }),
    );
  })();
  ...
  (() => {
    console.log(
      ...
      books.some(({ title }) => title.includes('and')),
    );
  })();
  ...
  (() => {
    console.log(
      ...
      books.some(({ title }) => title === 'J.R.R. Tolkien'),
    );
  })();
  ...
  (() => {
    console.log(
      ...
      books.some(({ genre, rating }) => genre === 'Historical' && rating > 4.7),
    );
  })();
  ...
  (() => {
    console.log(
      ...
      books.every(book => book.year > 1950),
    );
  })();
  ...
  (() => {
    console.log(
      ...
      books.every(({ genre }) => genre === 'Fiction'),
    );
  })();
  ...
  (() => {
    console.log(
      ...
      books.every(({ author }) => author.startsWith('J')),
    );
  })();
  ...
  (() => {
    console.log(
      ...
      books.every(({ title }) => title.includes('the')),
    );
  })();
  ...
  (() => {
    console.log(
      ...
      books.every(({ genre }) => genre === 'Adventure'),
    );
  })();
  ...
  (() => {
    console.log(
      'масив років видання всіх книжок з доданими 5 роками до кожного',
      books.map(({ year }) => year + 5),
    );
  })();
  ...
  (() => {
    console.log(
      "масив об'єктів, які містять назву книжки та її рейтинг у відсотках",
      books.map(({ title, rating }) => ({ title, rating: rating * 10 * 2 })),
    );
  })();
  ...
  (() => {
    console.log(
      'масив рядків, що містять інформацію про кожну книжку в форматі "назва - автор"',
  ...
  (() => {
    console.log(
      'кожна книжка має поле `discountPrice` ціною зниженою на 10%',
      books.map(book => {
        const newBook = { ...book };
        newBook.discountPrice = newBook.price - (newBook.price * 10) / 100;
        return newBook;
      }),
    );
  })();
  ...
  (() => {
    console.log(
      'містять назву книжки та її ціну з доданим податком 15%.',
      books.map(({ title, price }) => {
        const newPrice = price + (price * 15) / 100;
        return { title, price: newPrice };
      }),
    );
  })();
  ...
  (() => {
    console.log(
      'масив назв книжок, які видані після 2000 року.',
      books.filter(({ year }) => year > 2000).map(({ title }) => title),
    );
  })();
  ...
  (() => {
    console.log(
      'Додати до книжок поле isClassic: true для виданих до 1950 року.',
  ...
  (() => {
    console.log(
      'масив жанрів всіх книжок у верхньому регістрі.',
      books.map(({ genre }) => genre.toUpperCase()),
    );
  })();
  ...
  (() => {
    console.log(
      'масив назв книжок, де всі слова в назві починаються з великої літери',
      books.map(({ title }) => {
  ...
  (() => {
    console.log(
      "масив об'єктів, що містять лише автора та рік видання",
      books.map(({ author, year }) => ({ author, year })),
    );
  })();
  ...
  (() => {
    console.log(
      'масив цін книжок, конвертованих з доларів у євро',
      books.map(({ price }) => price * 0.85),
    );
  })();
  ...
  (() => {
    console.log(
      'масив назв книжок з доданим в кінці рядком "(Special Edition)"',
      books.map(({ title }) => `${title} (Special Edition)`),
    );
  })();
  ...
  (() => {
    console.log(
      "масив об'єктів з полем `shortTitle` що містить перше слово з назви.",
      books.map(book => ({ ...book, shortTitle: book.title.split(' ')[0] })),
    );
  })();
  ...
  (() => {
    const newBooks = books.map(book => {
      const description = `Ця книга від автора ${book.author} була видана у ${book.year} році`;
      const newBook = { ...book, description };
      return newBook;
    });
    console.log("масив об'єктів з `description`", newBooks);
  })();
  ...
  (() => {
    console.log(
      "масив об'єктів, що містять лише назву та жанр кожної книжки, де жанр",
      'записаний у нижньому регістрі: ',
      books.map(({ title, genre }) => {
        return { title, genre: genre.toLowerCase() };
      }),
    );
  })();
  ...
  (() => {
    console.log(
      ...
      books.toSorted((first, second) => first.year - second.year),
    );
  })();
  ...
  (() => {
    console.log(
      ...
      books.toSorted((a, b) => a.price - b.price),
    );
  })();
  ...
  (() => {
    console.log(
      'Відсортувати книги за автором у зворотньому алфавітному порядку',
      books.toSorted((a, b) => b.author.localeCompare(a.author)),
    );
  })();
  ...
  (() => {
    // const newBooks = {};
    // for (const book of books) {
    //   if (!Object.hasOwn(newBooks, book.genre)) {
    //     newBooks[book.genre] = [];
    //   }
    //   newBooks[book.genre].push(book);
    // }
    // const sortedKeys = Object.keys(newBooks).toSorted((a, b) =>
    //   a.localeCompare(b),
    // );
    // const sortedBooks = sortedKeys.flatMap(key => {
    //   return newBooks[key].toSorted((a, b) => b.title.localeCompare(a.title));
    // });
    const sortedBooks = books
      .toSorted((a, b) => b.title.localeCompare(a.title))
      .toSorted((a, b) => a.genre.localeCompare(b.genre));
    console.log(
      'Відсортувати книги за жанром у алфавітному порядку',
      'але книги одного жанру за',
      'назвою у зворотньому алфавітному порядку.',
      sortedBooks,
    );
  })();
  ...
  (() => {
    ...
    console.log(
      'Відсортувати книги за назвою у алфавітному порядку, але книги з однаковою',
      'назвою за автором у зворотньому алфавітному порядку.',
      sortedBooks,
    );
  })();
...
const carTasks = () => {
  ...
  console.log('Знайти авто заданого кольору', findCarByColor('Silver'));

  // 2. Знайти усі спорткари
  (() => {
    console.log(
      'Знайти усі спорткари',
      cars.filter(car => car.isSportCar),
    );
  })();
  ...
  (() => {
    console.log(
      ...
      cars.find(({ year }) => year === 2022),
    );
  })();

  // 4. Знайти авто певної марки
  function findCarByBrand(brand) {
    return cars.find(({ brand }) => brand === brand);
  }
  console.log('Знайти авто певної марки', findCarByBrand('Toyota'));
